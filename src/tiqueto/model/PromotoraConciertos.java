...
public class PromotoraConciertos extends Thread {
    ...
    @Override
    public void run() {
        //Mientras la venta no se haya cerrado...
        while (!webCompra.ventaTerminada.get()) {
            try {
                //si 1)no hay entradas a la venta, 2) al promotor le quedan entradas y 3)no se ha llegado al máximo que los fans pueden comprar en total...
                if (!webCompra.hayEntradas() && webCompra.entradasRestantes() > 0 && (NUM_FANS * MAX_ENTRADAS_POR_FAN) > webCompra.entradasVendidas) {
                    ...
                    //Si el número de entradas que me quedan es mayor o igual al del número de entradas que quiero reponer, repongo ese número
                ...
                // si 1)no hay entradas a la venta, 2) al promotor le quedan entradas y 3) se ha llegado al máximo que los fans pueden comprar en total...
                    ...
                    //Cerramos la venta porque, aunque al promotor le quedan entradas, los fans ya han llegado a sus máximos
